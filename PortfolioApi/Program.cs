...
// Render's proxy isn't in ASP.NET Core's default trusted-proxy list, so without
// clearing these, the middleware silently ignores the header and this fix does nothing.
