...
const fields = [
    ...
    },
    {
        ...
        type: "lines",
        helpText: "One URL per line, copied from Media Library — paste image/GIF URLs or MP4/WEBM video URLs in any order"
    },
    {
        name: "imageUrl",
        label: "Image URL",
...
const FontWeight = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$extension$2d$text$2d$style$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextStyle"].extend({
    addAttributes () {
        return {
            ...this.parent?.(),
            fontWeight: {
...
//# sourceMappingURL=src_18bs9t9._.js.map