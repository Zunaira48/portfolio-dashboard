...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$rolldown$2d$runtime$2d$D7D4PA$2d$g$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tiptap/core/dist/rolldown-runtime-D7D4PA-g.js [app-client] (ecmascript)");
...
const deleteSelection = ()=>({ state, dispatch })=>{
        ...
        if (dispatch) {
            ...
            if (!tr.selection.empty) tr.setSelection(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextSelection"].near(tr.doc.resolve(tr.selection.from)));
            tr.scrollIntoView();
            dispatch(tr);
        }
        return true;
...
function resolveFocusPosition(doc, position = null) {
    ...
    if (position === "all") return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextSelection"].create(doc, minMax(0, minPos, maxPos), minMax(doc.content.size, minPos, maxPos));
...
*/ function createNodeFromContent(content, schema, options) {
    ...
    if (isJSONContent) try {
        if (Array.isArray(content) && content.length > 0) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"].fromArray(content.map((item)=>schema.nodeFromJSON(item)));
    ...
    if (isTextContent) {
        if (options.errorOnInvalidContent) {
            ...
            if (options.slice) __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DOMParser"].fromSchema(contentCheckSchema).parseSlice(elementFromString(content), options.parseOptions);
            else __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DOMParser"].fromSchema(contentCheckSchema).parse(elementFromString(content), options.parseOptions);
...
const setContent = (content, { errorOnInvalidContent, emitUpdate = true, parseOptions = {} } = {})=>({ editor, tr, dispatch, commands })=>{
        ...
        if (parseOptions.preserveWhitespace !== "full") {
            ...
            if (dispatch) {
                const nodes = isFragment(document1) ? document1.content : [
                    document1
                ];
...
/** Splits a CSS style string into declarations, ignoring semicolons inside quotes/parentheses. */ function splitStyleDeclarations(styles) {
    const result = [];
    let current = "";
...
/** Yields property/value pairs from a style string. */ function parseStyleEntries(styles) {
    const pairs = [];
...
*/ function generateHTML(doc, extensions) {
    ...
    return getHTMLFromFragment(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Node"].fromJSON(schema, doc).content, schema);
}
//#endregion
...
*/ function generateText(doc, extensions, options) {
    const { blockSeparator = "\n\n", textSerializers = {} } = options || {};
    const schema = getSchema(extensions);
    return getText(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Node"].fromJSON(schema, doc), {
        blockSeparator,
        textSerializers: {
...
const setNode = (typeOrName, attributes = {})=>({ state, dispatch, chain })=>{
        ...
        return chain().command(({ commands })=>{
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$commands$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setBlockType"])(type, {
                ...attributesToCopy,
                ...attributes
            })(state)) return true;
...
const splitBlock = ({ keepMarks = true } = {})=>({ tr, state, dispatch, editor })=>{
        ...
        if (selection instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NodeSelection"] && selection.node.isBlock) {
            if (!$from.parentOffset || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$transform$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["canSplit"])(doc, $from.pos)) return false;
            if (dispatch) {
        ...
        if (dispatch) {
            if (can) {
                if (selection instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextSelection"]) tr.deleteSelection();
...
const splitListItem = (typeOrName, overrideAttrs = {})=>({ tr, state, dispatch, editor })=>{
        ...
        if ($from.parent.content.size === 0 && $from.node(-1).childCount === $from.indexAfter(-1)) {
            ...
            if (dispatch) {
                ...
                for(let d = $from.depth - depthBefore; d >= $from.depth - 3; d -= 1)wrap = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"].from($from.node(d).copy(wrap));
                ...
                wrap = wrap.append(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"].from(type.createAndFill(null, nextType) || void 0));
                ...
                if (sel > -1) tr.setSelection(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextSelection"].near(tr.doc.resolve(sel)));
                tr.scrollIntoView();
            }
            return true;
        }
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$transform$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["canSplit"])(tr.doc, $from.pos, 2)) return false;
        if (dispatch) {
...
const joinListBackwards = (tr, listType)=>{
    ...
    if (!(list.node.type === (nodeBefore === null || nodeBefore === void 0 ? void 0 : nodeBefore.type) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$transform$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["canJoin"])(tr.doc, list.pos))) return true;
...
const joinListForwards = (tr, listType)=>{
    ...
    if (!(list.node.type === (nodeAfter === null || nodeAfter === void 0 ? void 0 : nodeAfter.type) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$transform$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["canJoin"])(tr.doc, after))) return true;
...
const DECORATION_MANAGER_PLUGIN_KEY = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PluginKey"]("__tiptap_decorations__");
//#endregion
...
var commands_exports = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$rolldown$2d$runtime$2d$D7D4PA$2d$g$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])({
    blur: ()=>blur,
...
*/ const isDev = typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] !== "undefined" && ("TURBOPACK compile-time value", "development") !== "production";
//#endregion
...
*/ function mapDecorations(name, previous, tr) {
    ...
    const previousSet = (_previous$decorationS = previous.decorationSetsByExtension[name]) !== null && _previous$decorationS !== void 0 ? _previous$decorationS : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DecorationSet"].empty;
        ...
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Plugin"]({
            ...
            props: {
                decorations (state) {
                    ...
                    return (_DECORATION_MANAGER_P3 = (_DECORATION_MANAGER_P4 = DECORATION_MANAGER_PLUGIN_KEY.getState(state)) === null || _DECORATION_MANAGER_P4 === void 0 ? void 0 : _DECORATION_MANAGER_P4.mergedDecorationSet) !== null && _DECORATION_MANAGER_P3 !== void 0 ? _DECORATION_MANAGER_P3 : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DecorationSet"].empty;
                }
            }
        });
    }
...
*/ function createInlineMarkdownSpec(options) {
    ...
    return {
        parseMarkdown: (token, h)=>{
            ...
            if (content) return h.createNode(nodeName, attrs, [
                h.createTextNode(content)
            ]);
            return h.createNode(nodeName, attrs, []);
        },
        markdownTokenizer: {
...
* ```
*/ const TAB_STOP = 4;
/** Width of indentation in Markdown columns, where a tab runs to the next tab stop. */ function columnWidth(text) {
    let width = 0;
...
function renderNestedMarkdownContent(node, h, prefixOrGenerator, ctx, options) {
    ...
    let output = `${prefix}${h.renderChildren([
        content
    ])}`;
    if (children && children.length > 0) children.forEach((child, index)=>{
        var _h$renderChild, _h$renderChild2;
        const childContent = (_h$renderChild = (_h$renderChild2 = h.renderChild) === null || _h$renderChild2 === void 0 ? void 0 : _h$renderChild2.call(h, child, index + 1)) !== null && _h$renderChild !== void 0 ? _h$renderChild : h.renderChildren([
            child
        ]);
...
var markdown_exports = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$rolldown$2d$runtime$2d$D7D4PA$2d$g$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])({
	...
	*/ updateAttributes(attrs, checkMark) {
    ...
    ignoreMutation(mutation) {
        ...
        if (this.contentDOM.contains(mutation.target) && mutation.type === "childList" && (isiOS() || isAndroid()) && this.editor.isFocused) {
            ...
            ].every((node)=>node.isContentEditable)) return false;
        }
        ...
        state: {
            ...
            apply (tr, prev, state) {
                ...
                if (!!simulatedInputMeta) setTimeout(()=>{
                    ...
                    else text = getHTMLFromFragment(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"].from(text), state.schema);
...
var ExtensionManager = class {
	...
	*/ get plugins() {
        const { editor } = this;
        const allPlugins = sortExtensions([
            ...this.extensions
        ].reverse()).flatMap((extension)=>{
            const context = {
                name: extension.name,
                options: extension.options,
                storage: this.editor.extensionStorage[extension.name],
	...
	*/ dispatchTransaction(baseDispatch) {
        const { editor } = this;
        return sortExtensions([
            ...this.extensions
        ].reverse()).reduceRight((next, extension)=>{
            const context = {
                name: extension.name,
                options: extension.options,
                storage: this.editor.extensionStorage[extension.name],
            ...
            new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Plugin"]({
                ...
                props: {
                    clipboardTextSerializer: ()=>{
                        ...
                        return [
                            ...selection.ranges
                        ].sort((a, b)=>a.$from.pos - b.$from.pos).map(({ $from, $to })=>getTextBetween(doc, {
                                from: $from.pos,
                                to: $to.pos
...
var extensions_exports = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$rolldown$2d$runtime$2d$D7D4PA$2d$g$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["t"])({
...
*/ function warnOnDuplicatedProseMirrorModel(schema) {
    ...
    if (content instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"]) return;
...
*/ function wrappingInputRule(config) {
    return new InputRule({
        ...
        handler: ({ state, range, match, chain })=>{
            ...
            if (before && before.type === config.type && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$transform$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["canJoin"])(tr.doc, range.from - 1) && (!config.joinPredicate || config.joinPredicate(match, before))) tr.join(range.from - 1);
        },
        undoable: config.undoable
    });
}
...
/** Create a new JSX element from the given spec */ function createJSXElement(spec) {
    const element = spec;
    jsxElements.add(element);
    return element;
}
/** Check if a spec is a JSX element */ function isJSXElement(value) {
...
function render(tag, attributes) {
    ...
    if (Array.isArray(children)) {
        ...
        if (children.length === 0) return createJSXElement([
            tag,
            rest
        ]);
        const flattenedChildren = flattenFragmentChildren(children);
        if (flattenedChildren.length === 0) return createJSXElement([
            tag,
            rest
        ]);
...
"[project]/node_modules/@tiptap/core/dist/rolldown-runtime-D7D4PA-g.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=node_modules_%40tiptap_core_dist_0a7ob22._.js.map